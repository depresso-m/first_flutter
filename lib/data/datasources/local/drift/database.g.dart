...
class $CartItemsTable extends CartItems
  ...
  static const VerificationMeta _medicinePriceMeta = const VerificationMeta(
    'medicinePrice',
  );
  @override
  ...
  static const VerificationMeta _medicineImageUrlMeta = const VerificationMeta(
    'medicineImageUrl',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    Insertable<CartItemsData> instance, {
  ...
  CartItemsData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CartItemsData(
      ...
      medicineDescription: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}medicine_description'],
      ),
      medicinePrice: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}medicine_price'],
      )!,
      medicineImageUrl: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}medicine_image_url'],
      ),
      medicineManufacturer: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}medicine_manufacturer'],
      ),
...
class CartItemsData extends DataClass implements Insertable<CartItemsData> {
  ...
  factory CartItemsData.fromJson(
    ...
    return CartItemsData(
      ...
      medicineDescription: serializer.fromJson<String?>(
        json['medicineDescription'],
      ),
      ...
      medicineManufacturer: serializer.fromJson<String?>(
        json['medicineManufacturer'],
      ),
...
class CartItemsCompanion extends UpdateCompanion<CartItemsData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (medicineManufacturer.present) {
      map['medicine_manufacturer'] = Variable<String>(
        medicineManufacturer.value,
      );
    }
    if (quantity.present) {
